...
namespace Algorithm
{
  ...
  class Player
  {
    ...
    void AStar()
    {
      ...
      // 대각선의 비용이 14인 이유는 컴퓨터에서는 정수계산 속도가 더 빠르기 때문이다.
      // 따라서 좌우상하는 1 대각선은 1.4이지만 10을 곱해준것.
      ...
      // H = 목적지에서 얼마나 가까운지 ( 작을 수록 좋음, 고정 ) // 대각선 비용은 계산하지 않고 수평 수직으로만 값을 측정한다.
